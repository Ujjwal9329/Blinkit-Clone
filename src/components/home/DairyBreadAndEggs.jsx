...
import { DairyBreadAndEggsData } from "../../data/index";
...
const DairyBreadAndEggs = () => {
  ...
  return (
    <div className="container">
      <div className="title-container d-flex justify-content-between align-items-center mx-3">
        <h2 className="title fw-bold">Dairy, Bread, and Eggs</h2>
      ...
      <div className="container d-flex position-relative">
        ...
        <div
          ...
          <div
            ...
            {DairyBreadAndEggsData.map((data, index) => (
